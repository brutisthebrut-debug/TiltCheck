          ...
          <CardContent className="space-y-6">
            ...
            {isSettled && (bet.reasoningQuality || bet.whatHappened || bet.missReason) && (
              <div className="space-y-3 pt-2 border-t">
                ...
                <Link href="/lessons" className="inline-flex items-center gap-1 text-xs text-primary hover:underline underline-offset-4" data-testid="link-bet-lesson-library">
