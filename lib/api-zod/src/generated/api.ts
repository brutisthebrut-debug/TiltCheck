...
export const ListCrewsResponseItem = zod.object({
  ...
  "inviteCode": zod.string().describe('Shareable join code — sharing is free; a second Crew requires paid access'),
...
export const GetBillingStatusResponse = zod.object({
  "isPro": zod.boolean().describe('Whether this account may join or create more than one Crew'),
  "proUntil": zod.string().nullable().describe('End of the server-verified multi-Crew subscription horizon (ISO timestamp); null for a founder\/demo bypass or an unpaid account'),
  "source": zod.enum(['subscription', 'founder', 'demo', 'none']).describe('Why the account does (or does not) have multi-Crew access')
})
...
export const GetAdminOverviewResponse = zod.object({
  ...
  "totalWagered": zod.number(),
  "betaQualifiedMembers": zod.number().describe('Non-founder testers with a first play, process review, seven-day return, and Crew membership'),
  "betaTesterTarget": zod.number().describe('Evidence target for the private beta'),
  "members": zod.array(zod.object({
  "userId": zod.number(),
  "displayName": zod.string(),
  "avatarColor": zod.string(),
  ...
  "totalWagered": zod.number(),
  "reviewedPlays": zod.number().describe('Settled plays with a recorded process-quality review'),
  "crewMemberships": zod.number().describe('Number of Crews this member belongs to'),
  "firstPlayAt": zod.string().nullable().describe('When this member logged their first play'),
  "firstReviewAt": zod.string().nullable().describe('When this member first settled a play with a process review'),
  "returnedWithin7Days": zod.boolean().describe('Whether a second play was logged within seven days of the first'),
